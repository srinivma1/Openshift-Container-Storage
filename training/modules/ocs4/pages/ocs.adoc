...
----
**Note** If the machinesets fails to be in a  ready state, change the ami-id to the working node ami-id by describing the machine set for working node id and fetching the ami-id.
