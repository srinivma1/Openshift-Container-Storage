...
[source,role="execute"]
----
curl -s https://raw.githubusercontent.com/srinivma1/Openshift-Container-Storage/blob/master/training/modules/ocs4/attachments/cluster-workerocs-us-east-2.yaml | sed -e "s/CLUSTERID/${CLUSTERID}/g" | oc apply -f -
----
